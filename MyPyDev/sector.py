...
def main(plot):
    initialCash = 10000
    instrumentsByClass = {
        "US Stocks": ["IVV","IWM","IWF","IWD"],
        "Foreign Stocks": ["EFA","EEM","EWJ","EZU"],
        "US 10 Year Government Bonds": ["AGG","LQD","HYG","TIP"],
        "Real Estate": ["IYR","ICF","REM","IFGL"],
        "Commodities": ["IAU","SLV","GSG","PICK"],
    }
    ...
    feed = yahoofinance.build_feed(instruments, 2005, 2015, "data", skipErrors=True)
