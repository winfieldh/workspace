...
def main(plot):
    initialCash = 10000
    instrumentsByClass = {
#         "US Stocks": ["VTI","VO","VB","IWC"],
#         "Foreign Stocks": ["VEU","VWO","GWX","EWX"],
#         "US 10 Year Government Bonds": ["IEF","BND","TIP","BWX","ESD"],
#         "Real Estate": ["VNQ","RWX"],
#         "Commodities": ["DBC","DBA","DBE","DBB","DBP","IGF","TREE"],
            "IVY":["VTI","VB","VEU","VWO","BND","TIP","VNQ","RWX","DBC","GSG","QQQ"] }
